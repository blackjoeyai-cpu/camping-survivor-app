...
int _appSettingsEstimateSize(
  ...
  {
    final value = object.lastSyncTime;
    if (value != null) {
      bytesCount += 3 + value.length * 3;
    }
  }
  {
    final value = object.selectedLanguage;
    if (value != null) {
      bytesCount += 3 + value.length * 3;
    }
  }
...
void _appSettingsSerialize(
  ...
  writer.writeString(offsets[1], object.lastSyncTime);
  writer.writeString(offsets[2], object.selectedLanguage);
}
...
AppSettings _appSettingsDeserialize(
  ...
  object.id = id;
  object.lastSyncTime = reader.readStringOrNull(offsets[1]);
  object.selectedLanguage = reader.readStringOrNull(offsets[2]);
  return object;
}
...
extension AppSettingsQueryFilter
  ...
  QueryBuilder<AppSettings, AppSettings, QAfterFilterCondition>
      lastSyncTimeContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppSettings, AppSettings, QAfterFilterCondition>
      lastSyncTimeMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension AppSettingsQueryWhereDistinct
  ...
  QueryBuilder<AppSettings, AppSettings, QDistinct> distinctByLastSyncTime(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'lastSyncTime', caseSensitive: caseSensitive);
    });
  }
...
extension AppSettingsQueryProperty
  ...
  QueryBuilder<AppSettings, String?, QQueryOperations> lastSyncTimeProperty() {
    return QueryBuilder.apply(this, (query) {
